...
<body>
                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="contact.php">Complaint</a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="COMPLAINT/index.php">Complaint</a>
                                </li>
                            </ul>
                            <!-- Search btn -->
                            <div class="dorne-search-btn">
                                <a id="search-btn" href="contact.php"><i class="fa fa-search" aria-hidden="true"></i> Search</a>
                            </div>
                            <!-- Signin btn -->
                            ...
                            <div class="dorne-add-listings-btn">
                                <a href="index.php" class="btn dorne-btn">Search</a>
                            </div>
                        </div>
                    </nav>
                </div>
    ...
    <!-- ***** Welcome Area Start ***** -->
    <section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/w.jpg);">
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form">
                        ...
                        <div class="nav nav-tabs" id="heroTab" role="tablist">
                            ...
                            <a class="nav-item nav-link" id="nav-events-tab" data-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false">Area</a>
                        </div>
                        <!-- Tabs Content -->
